...
**Professional Contributions**
 Amna Bi Hafez — Analytics & BI Lead
...
1. Initialize Database: Execute the scripts within the /Database_Engineering folder.
2. Execute Analytics: Run python rfm_analysis.py and python basket_analysis.py.
3. Monitor Insights: Open the .pbix file and select Refresh to visualize the latest production data.
